        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="no_telpon" id="no_telpon" class="form-control" disabled>
                </div>
                <div class="form-group">
                    <label for="orangtua">Nama Orang Tua</label>
                    <input type="text" name="orangtua" id="orangtua" class="form-control" disabled>
                </div>
                <div class="form-group">
                    <label for="no_telpon_orangtua">Nomor Telpon Orang Tua</label>
                    <input type="text" name="no_telpon_orangtua" id="no_telpon_orangtua" class="form-control" disabled>
                </div>
                <div class="form-group">
